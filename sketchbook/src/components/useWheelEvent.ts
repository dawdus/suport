...
const recognizeGesture = ({ deltaX, deltaY, ctrlKey, clientX, clientY }: WheelEvent): Gesture =>
  ctrlKey
    ? {
        type: 'zoom',
...
export const useWheelEvent = (): [React.MutableRefObject<HTMLDivElement | null>, Gesture | undefined] => {
  const [gesture, setGesture] = React.useState<Gesture>();
